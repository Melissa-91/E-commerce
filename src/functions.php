...
function displayPanier(){
  ...
  if (!isset ($_SESSION["panier"]) || sizeof($_SESSION['panier'])==0) {
    echo '<h1>Votre panier est vide !</h1>'.displayProduit();
  }
...
';
 $total_price = 0;
  ...
  foreach ($_SESSION["panier"] as $key => $value) {
    ...
    <td>'.$value["name"].'<img src="'.BASE_URL.SP."images".SP."produit".SP.$value["image"].'" alt="..."/></td>
    <td>'.$value["price"].'€</td>
    <td>1</td>
    <td><a href="'.BASE_URL.SP."supprimer".SP.$key.'" class="btn btn-block btn-primary">Supprimer</a></td>
  </tr>  ';
  }
  ...
  $result .= '<a href="'.BASE_URL.SP."validationCommande".SP.$key.'" class="btn btn-block btn-success">Valider la commande</a>';
  return $result;
}
...
<div class="mt-2">
<a href="'.BASE_URL.SP."updateProfil".'" class="btn btn-primary">Mettre à jours mes informations</a>
</div>
';
  ...
  <form class="row g-3" action="updateAction" method="post">
    ...
    <div class="col-12">
      ...
      <div class="col-6">
        ...
        <input type="text" name="adresse_livraison" value="'.$_SESSION['customer']['adresse_livraison'].'" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
      </div>
      <div class="col-6">
        <label for="inputAddress2" class="form-label">Adresse de facturation</label>
        <input type="text" name="adresse_facturation" value="'.$_SESSION['customer']['adresse_facturation'].'" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
      </div>
...
function displayValidationCommande(){
  ...
  if(isset($_SESSION["customer"])){//l'utilisateur est connecté
    ...
    $result = "Votre commande à bien été validée rendez-vous dans 2h en magasin !";
